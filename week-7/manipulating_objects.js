...
// I had to remind myself of the notation for the delete function, so I found it in Eloquent JavaScript and was able to write it and pass the test.
//
// How difficult was it to add and delete properties outside of the object itself?
// Not difficult at all. It's almost too easy, if you use the dot notation to add properties.
//
// What did you learn about manipulating objects in this challenge?
// I learned that you can add properties using dot notation, which is quicker than the bracket notation I use for Ruby hashes. I was also surprised how the console displayed the circular data (spouse) and the third-level nested objects(carter: [Object]) when it printed terah.
